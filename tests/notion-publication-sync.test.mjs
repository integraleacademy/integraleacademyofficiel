...
test('le dispatch explicite reste limité au dépôt et aux branches Work attendus', () => {
  assert.ok(syncWorkflow.includes("startsWith(inputs.branch, 'work/notion-site-officiel-')"));
  assert.ok(syncWorkflow.includes("startsWith(inputs.pr_url, 'https://github.com/integraleacademy/integraleacademyofficiel/pull/')"));
