...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="fr"><body className="bg-academy-bg text-academy-ink"><Header/><main>{children}</main><Footer/><StickyMobileCTA/><ProjectTrainingPopup/></body></html>}
