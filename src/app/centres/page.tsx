...
export const metadata={
  alternates: { canonical: '/centres' },title:'Nos centres',description:'Les centres Intégrale Academy à Puget-sur-Argens, Paris et Aurillac pour les formations sécurité, VTC et BTS.'};
