...
export default function Home(){
  ...
  return <>
    ...
    <VisualSection tone="security"><section id="formations-securite" data-security-training-section className="scroll-mt-28 page-container py-12"><div data-security-training-heading><SectionTitle eyebrow="1. Sécurité privée" title={<>Formations professionnelles aux <Highlight>métiers qui recrutent</Highlight></>}>Ces formations visent l’accès ou l’évolution dans les métiers de la sécurité privée, de la protection rapprochée, du management sécurité ou de la sécurité incendie.</SectionTitle></div><SecurityTrainingGrid formations={securityHighlights}/></section></VisualSection>
