  ...
  return (
    <main className="relative overflow-hidden pb-24 lg:pb-0">
      ...
      <section className="relative isolate overflow-hidden bg-[#0A1725] px-4 pb-8 pt-10 text-white sm:pt-14 lg:pt-16">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_12%_76%,rgba(74,168,255,.25),transparent_29%),radial-gradient(circle_at_87%_12%,rgba(239,184,50,.22),transparent_28%),linear-gradient(135deg,#07111E_0%,#0E2035_62%,#111922_100%)]" />
          ...
          <div className="grid items-center gap-9 lg:grid-cols-[1.08fr_.92fr] lg:gap-12">
            <div>
              ...
              <h1 className="mt-5 max-w-4xl text-4xl font-black tracking-[-.06em] sm:text-5xl lg:text-6xl xl:text-7xl">
                Devenez celui qui <span className="text-[#FFD56A]">pilote la sécurité.</span>
              </h1>
      ...
      <nav aria-label="Sommaire du BTS MOS" className="sticky top-0 z-30 hidden border-b border-academy-line bg-[#FFFDF8]/95 px-4 py-3 backdrop-blur lg:block">
        <div className="page-container flex items-center justify-between gap-5">
          <span className="text-xs font-black">BTS MOS</span>
      ...
      >
        ...
        <div className="mt-5 flex flex-col items-start justify-between gap-4 rounded-[1.7rem] border border-yellow-300 bg-yellow-50 p-5 sm:flex-row sm:items-center">
          ...
          <span className="rounded-full bg-white px-4 py-2 text-xs font-black text-academy-ink ring-1 ring-yellow-300">BTS MOS · RNCP 41000</span>
        </div>
      </Section>
      ...
      >
        <div className="grid gap-5 lg:grid-cols-[1.2fr_.8fr]">
          <article className="rounded-[2rem] bg-[#0D1725] p-6 text-white shadow-card sm:p-8">
            ...
            <div className="mt-6 grid gap-3">
              {[
                ['01', 'À l’école', 'Management, droit, organisation et relation client'],
                ['02', 'En entreprise', 'Des missions réelles au sein d’une équipe professionnelle'],
