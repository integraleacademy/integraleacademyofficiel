...
const contactHref = (subject = 'BTS Commerce International') =>
  `mailto:${aurelieEmail}?subject=${encodeURIComponent(subject)}`;

const skillCards = [
  {
    number: "01", label: "Relier",
    title: "Créer la relation",
    description: "Prospecter, négocier et fidéliser dans un environnement interculturel.",
    scenes: [
      { kind: "mission-map", description: "Animation d’un itinéraire commercial reliant plusieurs partenaires internationaux" },
    ],
  },
  {
    number: "02", label: "Coordonner",
    title: "Gérer les opérations",
    description: "Organiser les flux, les documents, les risques et le suivi import-export.",
    scenes: [
      { kind: "secure-vehicle", description: "Animation d’une expédition suivie tout au long de son acheminement" },
      { kind: "compliance", description: "Animation de documents douaniers et réglementaires vérifiés avant expédition" },
    ],
  },
  {
    number: "03", label: "Développer",
    title: "Conquérir des marchés",
    description: "Analyser les opportunités et construire un développement commercial international.",
    scenes: [
      { kind: "risk-radar", description: "Animation d’opportunités repérées et comparées sur plusieurs marchés internationaux" },
      { kind: "finance", description: "Animation d’indicateurs permettant de piloter une activité internationale" },
    ],
  },
  {
    number: "04", label: "Communiquer",
    title: "Travailler entre cultures",
    description: "Mobiliser l’anglais, une seconde langue vivante et les bons codes professionnels.",
    scenes: [
      { kind: "briefing", description: "Animation d’un échange commercial préparé dans un contexte interculturel" },
    ],
  },
...
const program = [
  ...
  ['02', 'Anglais et seconde langue vivante', 'Communiquer avec des clients, fournisseurs et partenaires dans un contexte professionnel international.'],
  ['03', 'Culture économique, juridique et managériale', 'Comprendre l’environnement économique, le droit et les décisions qui structurent les organisations.'],
  ['04', 'Relation commerciale dans un environnement interculturel', 'Prospecter, négocier, exploiter les données clients et entretenir une relation commerciale internationale.'],
  ['05', 'Mise en œuvre des opérations internationales', 'Organiser, sécuriser et suivre les opérations import-export, de la commande jusqu’à la livraison.'],
  ['06', 'Développement commercial international', 'Étudier les marchés, repérer des opportunités et contribuer au développement de l’entreprise à l’étranger.'],
] as const;
...
const faq = [
  {
    ...
    a: 'Oui. Le BTS Commerce International est accessible aux titulaires d’un baccalauréat ou d’un titre équivalent, sous réserve de l’étude du dossier et de la validation du projet d’alternance.',
  },
  {
  ...
  {
    q: 'Quel niveau de langue faut-il pour commencer ?',
    a: 'Il faut avoir envie de progresser et être intéressé par les langues et les cultures étrangères. Le parcours comprend l’anglais ainsi qu’une seconde langue vivante, avec un travail régulier dans des situations professionnelles.',
  },
  {
  ...
  },
  {
    ...
    a: 'Oui. Le BTS Commerce International est un diplôme national de niveau 5. Pour la rentrée 2026, la certification est enregistrée au RNCP sous le numéro 41759.',
  },
  {
    q: 'Quels métiers peut-on exercer après le BTS Commerce International ?',
    a: 'Le BTS prépare notamment aux fonctions d’assistant import-export, gestionnaire import-export, assistant ADV export, agent de transit ou assistant référent douane. Il permet aussi de poursuivre ses études.',
  },
  {
...
function Eyebrow({ children, light = false }: { children: ReactNode; light?: boolean }) {
  return (
    <p className={`text-[.66rem] font-black uppercase tracking-[.24em] ${light ? 'text-cyan-300' : 'text-yellow-700'}`}>
      {children}
    </p>
  );
}
...
function HeroRoadmap() {
  const steps = [
    ...
    ['04', 'Votre premier poste', 'Import-export & international', 'GO'],
  ];
  return (
    <aside className="relative rounded-[2rem] border border-white/60 bg-[#FFFDF8] p-5 text-academy-ink shadow-[0_34px_100px_rgba(0,0,0,.34)] sm:p-6">
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-black">Objectif : BTS CI</h2>
        </div>
      ...
      <div className="mt-3 grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border border-academy-line bg-white p-4">
          <p className="text-[.6rem] font-black uppercase tracking-[.15em] text-cyan-700">Ou à distance</p>
...
export function BtsCiReferencePage() {
  return (
    <main className="relative overflow-x-clip pb-24 lg:pb-0">
        ...
        dangerouslySetInnerHTML={{
          __html: serializeCourseJsonLd({
            ...
            '@graph': [
              {
                '@type': 'Course',
                name: 'BTS Commerce International (CI)',
                description: 'BTS Commerce International en alternance, en présentiel à Puget-sur-Argens ou à distance en visioconférence.',
                educationalCredentialAwarded: 'BTS - diplôme national de niveau 5 - RNCP 41759',
                provider: {
              ...
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 3, name: 'BTS Commerce International', item: '/bts/commerce-international' },
                ],
              },
            ],
      ...
      <section className="relative isolate overflow-hidden bg-[#0A1725] px-4 pb-8 pt-10 text-white sm:pt-14 lg:pt-16">
        ...
        <div className="page-container">
          <div className="grid items-center gap-9 lg:grid-cols-[1.08fr_.92fr] lg:gap-12">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-cyan-300/35 bg-white/8 px-4 py-2 text-[.66rem] font-black uppercase tracking-[.18em] text-cyan-100 backdrop-blur">
                <span className="h-2.5 w-2.5 rounded-full bg-academy-gold shadow-[0_0_16px_rgba(239,184,50,.9)]" />
                Diplôme d’État · Bac+2 · Niveau 5 · RNCP 41759
              </span>
              <h1 className="mt-5 max-w-4xl text-4xl font-black tracking-[-.06em] sm:text-5xl lg:text-6xl xl:text-7xl">
                Faites du monde <span className="text-[#FFD56A]">votre terrain de jeu.</span>
              </h1>
              <p className="mt-5 max-w-2xl text-lg font-medium leading-8 text-white/70 sm:text-xl">
                Avec le BTS Commerce International, apprenez à prospecter de nouveaux marchés, gérer des opérations import-export et communiquer avec des partenaires du monde entier.
              </p>
      ...
      <CourseJourney course="bts-ci" />

      <BtsSectionNavigation code="CI" competencyHref="#competences" competencyLabel="Compétences" faqHref="#faq-ci" registrationHref={applicationUrl} />
      ...
      <Section
        ...
        title={<>Un projet qui ouvre vos horizons. Un parcours qui rassure vos parents.</>}
        intro={<>Un BTS pour celles et ceux qui aiment les langues, les échanges, les cultures et l’idée de travailler avec le monde entier.</>}
      >
        <div className="grid gap-5 lg:grid-cols-2">
          <article className="rounded-[2rem] border border-[#22354C] bg-[#0D1725] p-6 text-white shadow-card sm:p-8">
            <span className="grid h-14 w-14 place-items-center rounded-2xl bg-cyan-400/15 text-2xl text-cyan-300">↗</span>
            <Eyebrow light>Pour le futur étudiant</Eyebrow>
            <h3 className="mt-4 text-3xl font-black tracking-[-.04em]">Vous êtes curieux, à l’aise avec les langues et attiré par l’ailleurs.</h3>
            <p className="mt-4 leading-7 text-white/62">Le BTS CI transforme cette ouverture en compétences concrètes : négociation, import-export, logistique, langues et communication interculturelle.</p>
            <div className="mt-6 grid gap-3">
              {['De vraies missions à dimension internationale', 'L’anglais professionnel au quotidien', 'Des compétences utiles dans tous les secteurs'].map((item) => (
          ...
          <article className="rounded-[2rem] border border-academy-line bg-[#FFFDF8] p-6 shadow-card sm:p-8">
            ...
            <p className="mt-4 leading-7 text-academy-muted">Le parcours associe un diplôme national, deux années d’expérience professionnelle et le suivi d’une équipe BTS clairement identifiée.</p>
            <div className="mt-6 grid gap-3">
              {['Diplôme d’État de niveau 5 — RNCP 41759', 'Sans frais de scolarité pour l’apprenti*', 'Accompagnement de la candidature jusqu’au contrat'].map((item) => (
            ...
            <CTA href={contactHref('Question d’un parent sur le BTS Commerce International')} variant="light" className="mt-6">Poser une question à Aurélie →</CTA>
          </article>
        </div>
      </Section>
      ...
      <Section
        id="competences"
        eyebrow="02 — Du premier contact à la livraison"
        title={<>Vous apprenez à faire circuler les affaires.</>}
        intro={<>Le BTS CI vous apprend à développer une relation commerciale interculturelle, coordonner des opérations et conquérir de nouveaux marchés.</>}
        tone="paper"
      >
        ...
        <div className="mt-6 grid items-center gap-5 rounded-[1.7rem] border border-blue-200 bg-blue-50 p-6 sm:grid-cols-[1fr_auto]">
          <div><Eyebrow>Votre montée en compétences</Eyebrow><h3 className="mt-3 text-2xl font-black text-blue-950">Une vision complète des échanges mondiaux.</h3><p className="mt-3 max-w-3xl text-sm leading-7 text-blue-950/70">Vous progressez de la prospection à la négociation, puis jusqu’au suivi logistique, douanier et commercial des opérations.</p></div>
          <div className="rounded-2xl border border-blue-200 bg-white/70 px-6 py-4"><p className="text-4xl font-black text-blue-700">3+1</p><p className="mt-2 max-w-[14rem] text-xs font-black uppercase tracking-[.12em] text-blue-950/70">blocs et compétence transversale</p></div>
        </div>
        <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {['Assistant import-export', 'Gestionnaire import-export', 'Assistant ADV export', 'Agent de transit'].map((job) => (
      ...
      >
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          <article className="rounded-[2rem] border border-[#284661] bg-[#102B48] p-6 text-white shadow-card sm:p-8">
            <span className="inline-flex rounded-full bg-cyan-400/15 px-3 py-2 text-[.62rem] font-black uppercase tracking-[.15em] text-cyan-200 ring-1 ring-cyan-300/30">◉ Classe virtuelle</span>
        ...
        <div className="mt-5 flex flex-col items-start justify-between gap-4 rounded-[1.7rem] border border-yellow-300 bg-yellow-50 p-5 sm:flex-row sm:items-center">
          ...
          <span className="rounded-full bg-white px-4 py-2 text-xs font-black text-academy-ink ring-1 ring-yellow-300">BTS CI · RNCP 41759</span>
        </div>
      </Section>
      ...
      <Section
        ...
        title={<>Apprenez. Négociez. Construisez déjà votre réseau.</>}
        intro={<>Deux années pour obtenir un diplôme, vivre de vraies opérations commerciales et construire une expérience qui dépasse les frontières.</>}
        tone="paper"
      >
        <div className="grid gap-5 lg:grid-cols-[1.2fr_.8fr]">
          <article className="rounded-[2rem] bg-[#0D1725] p-6 text-white shadow-card sm:p-8">
            ...
            <div className="mt-6 grid gap-3">
              {[
                ['01', 'À l’école', 'Langues, commerce, logistique, douane et négociation'],
                ['02', 'En entreprise', 'Clients, fournisseurs, contrats, expéditions et documents'],
          ...
          <article className="rounded-[2rem] border border-yellow-300 bg-[#F7E5AC] p-6 shadow-card sm:p-8">
            ...
            <CTA href={contactHref('Question sur le financement du BTS Commerce International')} variant="dark" className="mt-6">Poser ma question à Aurélie →</CTA>
        ...
        <article className="mt-5 rounded-[2rem] border border-academy-line bg-academy-bg p-6 shadow-soft">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ['Diplôme officiel', 'Diplôme national de niveau 5 — RNCP 41759.'],
      ...
      <Section
        ...
        title={<>Un programme ouvert sur le monde. Des compétences utiles dans chaque pays.</>}
        intro={<>Trois blocs professionnels pour maîtriser la relation interculturelle, les opérations internationales et le développement commercial.</>}
      >
        ...
        <div className="mt-7 grid gap-5 rounded-[2rem] bg-[#0D1725] p-6 text-white lg:grid-cols-[.72fr_1.28fr] lg:p-8">
          <div><Eyebrow light>Validation</Eyebrow><h3 className="mt-4 text-3xl font-black">Un diplôme national de niveau 5.</h3><p className="mt-4 leading-7 text-white/62">Le diplôme est obtenu avec une moyenne supérieure ou égale à 10/20 sur l’ensemble des épreuves prévues par le référentiel national.</p></div>
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[1.15fr_.85fr]">
            <article className="rounded-[2rem] bg-[#FFFDF8] p-6 text-academy-ink shadow-card">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {['Assistant import-export', 'Gestionnaire import-export', 'Assistant ADV export', 'Agent de transit', 'Assistant référent douane', 'Poursuite d’études'].map((job) => <span key={job} className="rounded-full border border-academy-line bg-academy-bg px-4 py-2 text-xs font-black">{job}</span>)}
              </div>
            </article>
            <article className="rounded-[2rem] bg-gradient-to-br from-[#EFB832] to-[#FFD56A] p-6 text-academy-gold-text shadow-gold">
              ...
              <h3 className="mt-3 text-3xl font-black">Prêt à ouvrir votre carrière au monde ?</h3>
      ...
      <div id="faq-ci">
        <PremiumFAQSection
          badge="FAQ BTS Commerce International"
          title="Tout comprendre avant de vous lancer"
          description="Admission, alternance, langues, entreprise, visioconférence, coût ou diplôme : Aurélie répond aux questions du jeune comme à celles de sa famille."
          items={faq}
          contactHref={contactHref('Question sur le BTS Commerce International')}
