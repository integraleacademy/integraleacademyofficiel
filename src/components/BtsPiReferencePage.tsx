...
const contactHref = (subject = 'BTS Professions Immobilières') =>
...
const program = [
  ...
  ['02', 'Anglais professionnel', 'Communiquer avec les clients et les partenaires dans les principales situations des métiers immobiliers.'],
  ['03', 'Environnement juridique et économique des activités immobilières', 'Comprendre le droit, l’économie et la réglementation qui encadrent les opérations immobilières.'],
  ['04', 'Conduite du projet immobilier du client en vente ou location', 'Prospecter, conseiller, constituer les dossiers, négocier et accompagner le client jusqu’à la conclusion de son projet.'],
  ['05', 'Administration des copropriétés et de l’habitat social', 'Préparer les décisions, suivre la gestion administrative et financière et accompagner les occupants.'],
  ['06', 'Professionnalité immobilière et gestion du bâti', 'Construire votre identité professionnelle et conseiller sur le bâti, les travaux, les risques et les enjeux climatiques.'],
] as const;
...
const faq = [
  {
    ...
    a: 'Oui. Le BTS Professions Immobilières est accessible aux titulaires d’un baccalauréat ou d’un titre équivalent, sous réserve de l’étude du dossier et de la validation du projet d’alternance.',
  },
  {
  ...
  {
    q: 'Faut-il déjà connaître le secteur immobilier ?',
    a: 'Non. Il faut surtout avoir le goût du contact, de la négociation, du travail organisé et l’envie de comprendre les projets immobiliers. Les connaissances juridiques, commerciales et techniques sont acquises progressivement pendant le BTS.',
  },
  {
  ...
  },
  {
    ...
    a: 'Oui. Le BTS Professions Immobilières est un diplôme national de niveau 5. Pour la rentrée 2026, la certification est enregistrée au RNCP sous le numéro 38380.',
  },
  {
    q: 'Le BTS remplit-il la condition d’aptitude professionnelle pour la carte professionnelle ?',
    a: 'Oui. Le BTS Professions Immobilières permet de remplir la condition d’aptitude professionnelle requise pour demander la carte professionnelle prévue par la loi Hoguet. Les autres conditions réglementaires restent également applicables.',
  },
  {
    q: 'Quels métiers peut-on exercer après le BTS Professions Immobilières ?',
    a: 'Le BTS prépare notamment aux fonctions de négociateur immobilier, conseiller location, gestionnaire locatif, assistant de copropriété ou gestionnaire junior. Il permet aussi de poursuivre ses études.',
  },
  {
    ...
    <aside className="relative rounded-[2rem] border border-white/60 bg-[#FFFDF8] p-5 text-academy-ink shadow-[0_34px_100px_rgba(0,0,0,.34)] sm:p-6">
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-black">Objectif : BTS PI</h2>
        </div>
...
export function BtsPiReferencePage() {
  return (
    <main className="relative overflow-hidden pb-24 lg:pb-0">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@graph': [
              {
                '@type': 'Course',
                name: 'BTS Professions Immobilières (PI)',
                description: 'BTS Professions Immobilières en alternance, en présentiel à Puget-sur-Argens ou à distance en visioconférence.',
                educationalCredentialAwarded: 'BTS - diplôme national de niveau 5 - RNCP 38380',
                provider: {
              ...
              },
              {
                ...
                itemListElement: [
                  ...
                  { '@type': 'ListItem', position: 3, name: 'BTS Professions Immobilières', item: '/bts/professions-immobilieres' },
                ],
              },
            ],
          }),
          ...
          <div className="grid items-center gap-9 lg:grid-cols-[1.08fr_.92fr] lg:gap-12">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-cyan-300/35 bg-white/8 px-4 py-2 text-[.66rem] font-black uppercase tracking-[.18em] text-cyan-100 backdrop-blur">
                ...
                Diplôme d’État · Bac+2 · Niveau 5 · RNCP 38380
              </span>
              <h1 className="mt-5 max-w-4xl text-4xl font-black tracking-[-.06em] sm:text-5xl lg:text-6xl xl:text-7xl">
                Entrez dans l’immobilier <span className="text-[#FFD56A]">par la grande porte.</span>
              </h1>
              <p className="mt-5 max-w-2xl text-lg font-medium leading-8 text-white/70 sm:text-xl">
                Avec le BTS Professions Immobilières, apprenez à vendre, louer, gérer et valoriser des biens tout en accompagnant des projets de vie concrets.
              </p>
      ...
      <nav aria-label="Sommaire du BTS Professions Immobilières" className="sticky top-0 z-30 hidden border-b border-academy-line bg-[#FFFDF8]/95 px-4 py-3 backdrop-blur lg:block">
        <div className="page-container flex items-center justify-between gap-5">
          <span className="text-xs font-black">BTS PI</span>
      ...
      <BtsStudentBenefits courseName="BTS Professions Immobilières" />

      <Section
        id="pour-qui"
        eyebrow="01 — Un choix qui parle à toute la famille"
        title={<>Un métier de terrain pour vous. Un diplôme solide pour vos parents.</>}
        intro={<>Un BTS pour celles et ceux qui aiment le contact, la négociation, le concret et l’idée d’accompagner des projets qui comptent.</>}
      >
        <div className="grid gap-5 lg:grid-cols-2">
          <article className="rounded-[2rem] border border-[#22354C] bg-[#0D1725] p-6 text-white shadow-card sm:p-8">
            ...
            <h3 className="mt-4 text-3xl font-black tracking-[-.04em]">Vous aimez convaincre, conseiller et voir les projets prendre vie.</h3>
            <p className="mt-4 leading-7 text-white/62">Le BTS PI transforme cette énergie en compétences concrètes : prospection, estimation, visite, négociation, location et gestion.</p>
            <div className="mt-6 grid gap-3">
              {['Des missions concrètes dès l’alternance', 'Un métier de relation et de terrain', 'Plusieurs voies : vente, location ou syndic'].map((item) => (
          ...
          <article className="rounded-[2rem] border border-academy-line bg-[#FFFDF8] p-6 shadow-card sm:p-8">
            ...
            <div className="mt-6 grid gap-3">
              {['Diplôme d’État de niveau 5 — RNCP 38380', 'Sans frais de scolarité pour l’apprenti*', 'Accompagnement de la candidature jusqu’au contrat'].map((item) => (
            ...
            <CTA href={contactHref('Question d’un parent sur le BTS Professions Immobilières')} variant="light" className="mt-6">Poser une question à Aurélie →</CTA>
          </article>
        </div>
      </Section>
      ...
      <Section
        id="competences"
        eyebrow="02 — Du premier contact à la remise des clés"
        title={<>Vous pilotez le projet immobilier.</>}
      ...
      >
        ...
        <div className="mt-5 flex flex-col items-start justify-between gap-4 rounded-[1.7rem] border border-yellow-300 bg-yellow-50 p-5 sm:flex-row sm:items-center">
          ...
          <span className="rounded-full bg-white px-4 py-2 text-xs font-black text-academy-ink ring-1 ring-yellow-300">BTS PI · RNCP 38380</span>
        </div>
      </Section>
      ...
      <Section
        ...
        title={<>Apprenez. Visitez. Négociez. Construisez déjà votre réseau.</>}
        intro={<>Deux années pour obtenir un diplôme, accompagner de vrais clients et construire une expérience professionnelle immédiatement visible sur votre CV.</>}
        tone="paper"
      >
        <div className="grid gap-5 lg:grid-cols-[1.2fr_.8fr]">
          <article className="rounded-[2rem] bg-[#0D1725] p-6 text-white shadow-card sm:p-8">
            ...
            <div className="mt-6 grid gap-3">
              {[
                ['01', 'À l’école', 'Droit, économie, transaction, gestion, bâti et communication'],
                ['02', 'En entreprise', 'Prospection, visites, mandats, dossiers, locations et copropriété'],
          ...
          <article className="rounded-[2rem] border border-yellow-300 bg-[#F7E5AC] p-6 shadow-card sm:p-8">
            ...
            <CTA href={contactHref('Question sur le financement du BTS Professions Immobilières')} variant="dark" className="mt-6">Poser ma question à Aurélie →</CTA>
        ...
        <article className="mt-5 rounded-[2rem] border border-academy-line bg-academy-bg p-6 shadow-soft">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ['Diplôme officiel', 'Diplôme national de niveau 5 — RNCP 38380.'],
      ...
      <Section
        ...
        title={<>Un programme ancré dans le réel. Des compétences pour tout l’immobilier.</>}
        intro={<>Trois grands pôles professionnels pour maîtriser la vente et la location, la copropriété et le conseil sur le bâti.</>}
      >
      ...
      <BtsCompleteInformation course="pi" />
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[1.15fr_.85fr]">
            <article className="rounded-[2rem] bg-[#FFFDF8] p-6 text-academy-ink shadow-card">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {['Négociateur immobilier', 'Conseiller location', 'Gestionnaire locatif', 'Assistant copropriété', 'Gestionnaire junior', 'Poursuite d’études'].map((job) => <span key={job} className="rounded-full border border-academy-line bg-academy-bg px-4 py-2 text-xs font-black">{job}</span>)}
              </div>
            </article>
            <article className="rounded-[2rem] bg-gradient-to-br from-[#EFB832] to-[#FFD56A] p-6 text-academy-gold-text shadow-gold">
              ...
              <h3 className="mt-3 text-3xl font-black">Prêt à ouvrir la porte de l’immobilier ?</h3>
      ...
      <div id="faq-pi">
        <PremiumFAQSection
          badge="FAQ BTS Professions Immobilières"
          title="Tout comprendre avant de vous lancer"
          description="Admission, alternance, métiers, entreprise, visioconférence, coût ou diplôme : Aurélie répond aux questions du jeune comme à celles de sa famille."
          items={faq}
          contactHref={contactHref('Question sur le BTS Professions Immobilières')}
