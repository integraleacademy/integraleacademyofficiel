...
type ButtonVariant = 'primary' | 'secondary' | 'ghost' | Exclude<UiAccent, 'gold'>;
...
const premiumFaqThemes: Record<UiAccent, { shell:string; glow:string; badge:string; contact:string; icon:string; item:string; bar:string; number:string; toggle:string; check:string }> = {
