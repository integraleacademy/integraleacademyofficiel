...
export function Header(){
  const trainingNav=[
    ['Métiers de la sécurité','/#formations-securite'],
    ['BTS en alternance','/#bts'],
    ['Chauffeur VTC','/vtc'],
  ] as const;
