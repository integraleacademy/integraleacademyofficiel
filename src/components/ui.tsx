...
export function Footer(){
  ...
  return <footer className="relative mt-20 overflow-hidden bg-academy-ink px-4 pb-10 pt-12 text-white">
    ...
    <div className="relative mx-auto max-w-7xl">
      <div className="rounded-[2rem] bg-white p-5 text-academy-ink shadow-[0_30px_90px_rgba(17,17,17,.18)] ring-1 ring-academy-line md:rounded-[2.5rem] md:p-8">
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <p className="inline-flex items-center gap-2 rounded-full bg-academy-green/10 px-4 py-2 text-xs font-black uppercase tracking-[.18em] text-green-700"><span className="h-2.5 w-2.5 rounded-full bg-academy-green shadow-[0_0_0_6px_rgba(34,197,94,.12)]"/>Conseiller disponible</p>
            <h2 className="mt-5 max-w-3xl text-3xl font-black tracking-tight md:text-5xl">Prêt à démarrer votre formation&nbsp;?</h2>
            <p className="mt-4 max-w-3xl text-base leading-8 text-stone-600 md:text-lg">Sécurité, VTC ou BTS : un conseiller vous aide à valider votre parcours, vos prérequis et votre financement pour passer rapidement à l’inscription.</p>
            <div className="mt-5 flex flex-wrap gap-3 text-sm font-black text-stone-600"><span className="rounded-full bg-academy-bg px-4 py-2">Sans engagement</span><span className="rounded-full bg-academy-bg px-4 py-2">Réponse rapide</span><span className="rounded-full bg-academy-bg px-4 py-2">Accompagnement personnalisé</span></div>
          </div>
          <div className="grid gap-3 sm:grid-cols-2 lg:min-w-80 lg:grid-cols-1"><Link href="/contact" className="inline-flex items-center justify-center rounded-full bg-academy-ink px-7 py-4 text-sm font-black text-white shadow-[0_14px_35px_rgba(17,17,17,.18)] transition hover:-translate-y-0.5 hover:bg-black">Demander des informations →</Link><Link href="tel:0422470768" className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-academy-gold to-yellow-300 px-7 py-4 text-sm font-black text-academy-ink shadow-gold transition hover:-translate-y-0.5 hover:brightness-105">Appeler un conseiller</Link></div>
        </div>
      </div>
...
export function Footer(){return <footer className="border-t border-academy-line bg-white px-4 py-10 text-sm text-stone-600"><div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.2fr_.8fr_.8fr]"><div><Link href="/" className="inline-flex items-center gap-3 text-lg font-black text-academy-ink"><span className="grid h-10 w-10 place-items-center rounded-2xl bg-academy-gold text-academy-ink">IA</span>Intégrale Academy</Link><p className="mt-4 max-w-md leading-7">Centre de formation professionnelle : sécurité privée, sécurité incendie, VTC et BTS en alternance.</p></div><div><p className="font-black text-academy-ink">Accès rapides</p><div className="mt-3 grid gap-2"><Link href="/formations-securite" className="hover:text-yellow-700">Formations sécurité</Link><Link href="/bts" className="hover:text-yellow-700">BTS</Link><Link href="/financements" className="hover:text-yellow-700">Financements</Link><Link href="/contact" className="hover:text-yellow-700">Contact</Link></div></div><div><p className="font-black text-academy-ink">Contact</p><div className="mt-3 grid gap-2"><Link href="tel:0422470768" className="hover:text-yellow-700">04 22 47 07 68</Link><Link href="/mentions-legales" className="hover:text-yellow-700">Mentions légales</Link><Link href="/politique-confidentialite" className="hover:text-yellow-700">Politique de confidentialité</Link></div></div></div></footer>}
