...
export function Header(){
  const trainingNav=[
    ['Métiers de la sécurité','/#formations-securite','Parcours APS, SSIAP, A3P et dirigeant sécurité.','🛡️'],
