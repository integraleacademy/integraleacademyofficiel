...
export function SstReferencePage({ sessions }: { sessions: TrainingDatesPricingSession[] }) {
  ...
  return <main className="relative overflow-hidden pb-24 lg:pb-0">
    ...
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-academy-line bg-[#FFFDF8]/96 p-3 shadow-[0_-12px_40px_rgba(0,0,0,.12)] backdrop-blur lg:hidden"><div className="mx-auto flex max-w-lg gap-2"><CTA href="tel:0422470768" variant="light" className="min-w-0 flex-1 px-3">Appeler</CTA><CTA href={sessionHref(next)} variant="gold" className="min-w-0 flex-[1.4] px-3">Demander un devis</CTA></div></div>
  </main>;
}
