...
export const securityFormations: Formation[] = [
  {
    ...
    duration: '175 heures · 51 heures à distance · 124 heures en présentiel',
    ...
    program: [
      ...
      'UV 2 — Environnement juridique, 22 h : livre VI du CSI, déontologie, responsabilités, article 73, libertés publiques et principes de la République ; 20 h à distance.',
      'UV 3 — Gestion des conflits, 14 h : prévention, posture, communication et mises en situation ; 3 h à distance et 7 h de pratique.',
      'UV 4 — Module stratégique, 7 h : consignes, compte rendu, outils informatiques et main courante électronique ; 4 h à distance.',
      ...
      'UV 6 — Appréhension dans le cadre du métier, 7 h : application de l’article 73 du Code de procédure pénale ; 3 h à distance.',
      'UV 7 — Prévention des risques terroristes, 13 h : détection, protection, alerte, forces de l’ordre et secourisme tactique ; 7 h à distance et 3,5 h de pratique.',
      ...
      'UV 11 — Gestion des risques, 11 h : alarmes, levée de doute, GTC/GTB, PTI/DATI et risque électrique ; 2 h à distance et 5 h de pratique.',
      'UV 12 — Événementiel spécifique, 7 h : rassemblements, filtrage, billetterie, mouvements de foule et urgence ; 7 h à distance.',
      'UV 13 — Situations conflictuelles dégradées, 7 h : stress et réponse nécessaire et proportionnée ; 4 h de pratique.',
      'UV 14 — Risques industriels, 7 h : document unique, ICPE, SEVESO, ORSEC, SGH, CLP et ATEX ; 5 h à distance.',
    ],
    evaluation: [
    ...
    seo: {
      ...
      description: 'Suivez la formation APS à Puget-sur-Argens et préparez le TFP APS RNCP 36648 : 175 h, dont 124 h en présentiel et 51 h à distance.',
    },
  },
...
export const apsFaq = [
  { q: 'La formation APS est-elle 100 % à distance ?', a: 'Non. Sur les 175 heures, 51 heures sont réalisées à distance et 124 heures se déroulent en présentiel à Puget-sur-Argens. L’examen final est organisé en présentiel.' },
  { q: 'Combien d’heures se font à distance ?', a: 'Le parcours comprend 51 heures à distance, soit 29 % de la formation. Les dates sont précisées dans le calendrier de chaque session.' },
  { q: 'Combien d’heures se font en présentiel ?', a: '124 heures, soit 71 % du parcours, se déroulent au centre Intégrale Academy à Puget-sur-Argens : 63,5 heures de pratique et 60,5 heures de théorie en présentiel.' },
  ...
  { q: 'Le e-learning est-il obligatoire ?', a: 'Oui lorsqu’il est prévu au calendrier de la session. Les séquences programmées à distance font partie du parcours et doivent être suivies et validées ; elles représentent 51 heures.' },
  ...
  { q: 'Combien de temps dure la formation ?', a: 'La formation dure 175 heures au total : 51 heures à distance et 124 heures en présentiel.' },
