...
import { contactInfo, locations, socialLinks } from './locations';
import { allFormations, securityFormations, vtcFormation } from './formations';

export const contact = { ...contactInfo, locations, socialLinks };
export const formations = allFormations;
export const bts = btsFormations;
export { securityFormations, vtcFormation, locations, socialLinks };
