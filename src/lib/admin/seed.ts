...
export const seedTrainings = [
  ...
  { slug: 'a3p-apr', name: 'A3P', title: 'Agent de Protection Physique des Personnes', category: 'sécurité privée', description: '', pageUrl: '/formations-securite/a3p-apr' },
  ...
  { slug: 'desp-dssp', name: 'DESP / DSSP', title: 'Dirigeant d’entreprise de sécurité privée', category: 'direction', description: '', pageUrl: '/despvaeouinitial' },
  { slug: 'desp-initial', name: 'DESP initial', title: 'Formation DESP initial', category: 'direction', description: '', pageUrl: '/dirigeant' },
  { slug: 'desp-vae', name: 'DESP VAE', title: 'Validation des acquis dirigeant sécurité privée', category: 'direction', description: '', pageUrl: '/vaedirigeant' },
  ...
  for (const session of a3pSeedSessions) {
    await prisma.trainingSession.upsert({
      ...
      update: {
        ...
        showSeatsLeft: true,
        durationLabel: '328 heures hors examen',
        ...
        publicNotes: 'Formation de 328 heures hors examen, dont 92 heures et 50 minutes de pratique ; hébergement collectif possible sur réservation.',
